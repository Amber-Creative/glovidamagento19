				...
				var defaults = {
					...
					return this.each(function() {
						...
						if (window.tplogs==true)
						 try{
								console.groupCollapsed("Slider Revolution 4.6.2 Initialisation on "+jQuery(this).attr('id'));
		...
		*******************************************/
		...
		function initSlider(container,opt) {
						...
						if (opt.forceFullWidth=="on" && container.closest('.forcefullwidth_wrapper_tp_banner').length==0) {
							...
							container.parent().css({'backgroundColor':container.css('backgroundColor'),'backgroundImage':container.css('backgroundImage')});
