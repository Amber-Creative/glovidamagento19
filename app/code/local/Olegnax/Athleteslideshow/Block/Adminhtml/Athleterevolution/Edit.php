...
class Olegnax_Athleteslideshow_Block_Adminhtml_Athleterevolution_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
            ...
            <tr>
                ...
                <td width="250">
                    <select id="color_class">
                        ...
                        <option value="athlete_style_large">athlete_style_large</option>
                        <option value="athlete_style_medium">athlete_style_medium</option>
                        <option value="athlete_style_small">athlete_style_small</option>

                        <option value="athlete_large_caption_light">athlete_large_caption_light</option>
                        <option value="athlete_large_caption_medium">athlete_large_caption_medium</option>
                        <option value="athlete_large_caption_bold">athlete_large_caption_bold</option>

                        <option value="athlete_caption_light">athlete_caption_light</option>
                        <option value="athlete_caption_medium">athlete_caption_medium</option>
                        <option value="athlete_caption_bold">athlete_caption_bold</option>

                        <option value="athlete_caption_underline_light">athlete_caption_underline_light</option>
                        <option value="athlete_caption_underline_medium">athlete_caption_underline_medium</option>
                        <option value="athlete_caption_underline_bold">athlete_caption_underline_bold</option>

                        <option value="athlete_small_caption_light">athlete_small_caption_light</option>
                        <option value="athlete_small_caption_medium">athlete_small_caption_medium</option>
                        <option value="athlete_small_caption_bold">athlete_small_caption_bold</option>

                        <option value="athlete_small_text_light">athlete_small_text_light</option>
                        <option value="athlete_small_text_medium">athlete_small_text_medium</option>
                        <option value="athlete_small_text_bold">athlete_small_text_bold</option>

                        <option value="athlete_medium_text_light">athlete_medium_text_light</option>
                        <option value="athlete_medium_text_medium">athlete_medium_text_medium</option>
                        <option value="athlete_medium_text_bold">athlete_medium_text_bold</option>

                        <option value="athlete_white_bg_light">athlete_white_bg_light</option>
                        <option value="athlete_white_bg_medium">athlete_white_bg_medium</option>
                        <option value="athlete_white_bg_bold">athlete_white_bg_bold</option>
...
EOD;
	    ...
	    Mage::app()->getLayout()->getBlock('head')->addItem('js_css', 'olegnax/fancybox/jquery.fancybox-1.3.4.css');
	    Mage::app()->getLayout()->getBlock('head')->addJs('olegnax/fancybox/jquery.fancybox-1.3.4.pack.js');

    }

    public function getHeaderText()
    {
        if( Mage::registry('athleterevolution_data') && Mage::registry('athleterevolution_data')->getId() ) {
