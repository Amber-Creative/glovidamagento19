...
class Olegnax_Athleteslideshow_Block_Adminhtml_Athleterevolution_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
	protected function _prepareForm()
	{
		...
		$fieldset->addType('colorpicker', 'Olegnax_Athleteslideshow_Block_Adminhtml_Athleterevolution_Helper_Form_Colorpicker');
		...
		$fieldset->addField('slide_bg', 'colorpicker', array(
			'label' => Mage::helper('athleteslideshow')->__('Slide background'),
			'name' => 'slide_bg',
